import PopupDescriptionView from './popup-description.js';
import PopupCommentsView from './popup-comments.js';
...
const createSiteFilmDetailsPopup = (data, deletingcomment) => {
  ...
  <form class="film-details__inner" action="" method="get">
    <div class="form-details__top-container">
          ${new PopupDescriptionView(data).getTemplate()}
    </div>
    <div class="form-details__bottom-container">
          ${new PopupCommentsView(comments, userEmoji, deletingcomment, isDisabled, isDeleting, isSaving).getTemplate()}
    </div>
  </form>
</section>`
  );
...
export default class Popup extends Smart {
  ...
  _deleteClickHandler(targetComment) {
    ...
    this._callback.deleteClick(Popup.parseDataToFilm(newData), targetComment).then(()=>{
